...
FILTER_SANITIZE_STRING);
 ...
 if($errors){
 //print error message
 $resultMessage = '<div class="alert alertdanger">'
. $errors .'</div>';
 }else{
...
$resultMessage = '<div class="alert alertsuccess">Thanks
for your message. We will get back to you
as soon as possible!</div>';
 header("Location:
20.thanksforyourmessage.php");
 }else{
 $resultMessage = '<div class="alert alertwarning">Unable
